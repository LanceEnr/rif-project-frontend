        ...
        <table className="c37">
          <tr className="c34">
            <td className="c47 c73" colSpan={2} rowSpan={1}>
              <p className="c6">
                <span className="c16">Strategic Directional Areas (SDA)</span>
              </p>
              <p className="c1">
          ...
          <tr className="c34">
            ...
            <td className="c48" colSpan={1} rowSpan={1}>
              <p className="c6">
                <span className="c42">Community Development and Advocacy </span>
              </p>
            </td>
          </tr>
          <tr className="c34">
        ...
        <table className="c37">
          ...
          <tr className="c63">
            <td className="c19" colSpan={1} rowSpan={1}>
              <p className="c6">
                ...
                <span className="c26">
                  - Uncertainty which can lead to positive or negative result
                </span>
              </p>
            </td>
          </tr>
          ...
          <tr className="c63">
            <td className="c19" colSpan={1} rowSpan={1}>
              <p className="c6">
                ...
                <span className="c14">Degree or extent of damage or harm </span>
              </p>
            </td>
          </tr>
          <tr className="c63">
          ...
          <tr className="c63">
            <td className="c19" colSpan={1} rowSpan={1}>
              ...
              <p className="c6">
                ...
                <span className="c26">
                  &ndash; Level of risk after action to reduce it has been taken
                </span>
              </p>
            </td>
          </tr>
          ...
          <tr className="c127">
            <td className="c19" colSpan={1} rowSpan={1}>
              <p className="c6 c65">
                <span className="c14">
                  The Risk Identification Form (RIF) covers the following under
              ...
              <ul className="c75 lst-kix_list_5-0 start">
                ...
                <li className="c95 c65 li-bullet-0">
                  <span className="c14">
                    Sub-clause 4.4 Quality Management system and its processes
                  </span>
                </li>
              </ul>
              <p className="c6 c65">
              ...
              <p className="c6 c65">
                <span className="c14">Clause 9: Performance evaluation</span>
              </p>
              <ul className="c75 lst-kix_list_6-0">
                <li className="c65 c95 li-bullet-0">
                  <span className="c14">Sub-clause 9.3 Management review</span>
                </li>
              </ul>
              <p className="c6 c65">
