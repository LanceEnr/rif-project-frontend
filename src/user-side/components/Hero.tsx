...
const Hero: React.FC = () => {
  return (
    <>
      <section class="relative bg-cover object-center bg-fixed bg-[url('https://upload.wikimedia.org/wikipedia/commons/7/7b/400_Year_old_Beauty.jpg')] bg-blend-multiply">
