...
const AddStakeholders: FC = () => (
  <section
    className="relative bg-gray-50"
    style={{
      backgroundImage:
        "url(https://upload.wikimedia.org/wikipedia/commons/thumb/7/7b/400_Year_old_Beauty.jpg/1200px-400_Year_old_Beauty.jpg)",
    ...
    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 relative z-10">
      <div className="w-full bg-white rounded-lg shadow md:mt-0 sm:max-w-2xl p-8">
        <form action="#">
          ...
          <button
            type="submit"
            className="text-white bg-yellow-500 w-full font-medium rounded-lg text-sm px-5 py-2.5"
          >
            Save
          </button>
        </form>
