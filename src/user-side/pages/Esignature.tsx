...
import { MdKeyboardArrowDown, MdClose } from "react-icons/md"; // Import Close icon for the remove button
...
const Esignature: React.FC = () => {
  ...
  const handleSubmit = async () => {
    if (file && document.getElementById("professionalTitle")) {
      const professionalTitle = (
        document.getElementById("professionalTitle") as HTMLSelectElement
      ).value;
