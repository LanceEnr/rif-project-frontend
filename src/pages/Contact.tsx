    ...
    <section className="bg-white my-24">
      <div className="container px-6 py-12 mx-auto">
        <div className="text-center">
          <p className="font-medium text-yellow-500">Contact us</p>
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex flex-col items-center justify-center text-center">
            <span className="p-3 text-yellow-500 rounded-full bg-yellow-100/80">
            ...
            <p className="mt-2 text-yellow-500">hello@merakiui.com</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="mt-2 text-yellow-500">100 Smith Street Collingwood VIC 3066 AU</p>
          </div>
          ...
          <div className="flex flex-col items-center justify-center text-center">
            ...
            <p className="mt-2 text-yellow-500">+1 (555) 000-0000</p>
          </div>
        </div>
      </div>
    </section>
