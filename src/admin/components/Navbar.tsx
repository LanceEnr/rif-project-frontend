        ...
        <div className="flex flex-wrap justify-between items-center">
          ...
          <div className="flex items-center lg:order-2">
            ...
            <button
              ...
              type="button"
              className="p-2 text-gray-500 rounded-lg lg:hidden hover:text-gray-900 hover:bg-gray-100  dark:hover:bg-gray-700 dark:hover:text-white"
            >
            ...
            <button
              ...
              className="p-2 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100  dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
            >
            ...
            >
              <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 ">
                Notifications
              </div>
              <div>
                <a
            ...
            <button
              ...
              className="p-2 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100  dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
            >
              <span className="sr-only">View notifications</span>
              <svg
                className="w-4 h-4"
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4 p-4">
                ...
                >
                  <svg
                    className="mx-auto mb-2 w-5 h-5 text-gray-400 group-hover:text-gray-500  dark:group-hover:text-gray-400"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg"
                    fill="currentColor"
                    viewBox="0 0 18 20"
