                ...
                <ol className="relative border-s border-gray-200">                  
                    <li className="mb-10 ms-6">            
                        ...
                        <div className="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex">
                            ...
                            <div className="text-sm font-normal text-gray-500">Lance Editted <a href="#" className="font-semibold text-blue-600 hover:underline">Jese Leos</a> to <span className="bg-gray-100 text-gray-800 text-xs font-normal me-2 px-2.5 py-0.5 rounded">Funny Group</span></div>
                        </div>
                    </li>
                    <li className="mb-10 ms-6">
                        <span className="absolute flex items-center justify-center w-5 h-5 rounded-full -start-3 ring-8 ring-black">
                        ...
                        <div className="p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
                            <div className="items-center justify-between mb-3 sm:flex">
                                ...
                                <div className="text-sm font-normal text-gray-500 lex">Thomas Lean commented on  <a href="#" className="font-semibold text-gray-900hover:underline">Flowbite Pro</a></div>
                            </div>
                    ...
                    <li className="ms-6">
                        ...
                        <div className="items-center justify-between p-4 bg-white border border-gray-200 rounded-lg shadow-sm sm:flex">
                            ...
                            <div className="text-sm font-normal text-gray-500 lex ">Jese Leos has changed <a href="#" className="font-semibold text-blue-600hover:underline">Pricing page</a> task status to  <span className="font-semibold text-gray-900 ">Finished</span></div>
                        </div>
                    </li>
                </ol>
            </div>
