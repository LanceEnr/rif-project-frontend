...
const EditUser: React.FC = () => {
  ...
  <h1 className="border-b py-6 text-4xl font-semibold">Edit User Settings</h1>
    ...
    <div className="col-span-8 overflow-hidden rounded-xl sm:bg-gray-50 sm:px-8 sm:shadow">
      ...
      <button className="mt-4 rounded-lg bg-yellow-500 px-4 py-2 text-white">Save Password</button>
        ...
        <p className="py-2 text-xl font-semibold">Administrator Privilages</p>
          <label className="inline-flex items-center cursor-pointer">
            <input type="checkbox" value="" className="sr-only peer" checked/>
              <div className="relative w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-black-300 dark:peer-focus:ring-black-800 dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:start-[2px] after:bg-white after:border after:rounded-full after:h-5 after:w-5 after:transition-all  peer-checked:bg-yellow-500"></div>
