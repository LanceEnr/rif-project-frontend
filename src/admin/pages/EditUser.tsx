    ...
    <div className="w-screen-xl px-4 bg-white min-h-screen">
      ...
      <div className="col-span-8 overflow-hidden  ">
        ...
        <form>
          ...
          <button
            type="submit"
            className="text-white bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-yellow-500 dark:focus:ring-blue-800"
          >
            Submit
          </button>
        </form>
