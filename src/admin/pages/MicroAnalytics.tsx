              ...
              <div className="flex justify-between pb-4 mb-4 border-b border-gray-200">
                <div className="flex items-center">
                  <div className="w-12 h-12 rounded-lg bg-gray-100 flex items-center justify-center me-3">
                    <img
                      className="w-10 h-10 m-2.5 ms-1.5"
                ...
                <div className="flex justify-between items-center pt-5">
                  ...
                  >
                    ...
                    <svg
                      ...
                      aria-hidden="true"
                      xmlns="https://www.ust.edu.ph/wp-content/uploads/2020/02/UST-Seal-Institute-of-Information-Computing-Sciences-2014-Present-868x1024.png"
                      fill="none"
                      viewBox="0 0 10 6"
                    >
                      <path
          ...
          <div className="max-w-sm w-full bg-white rounded-lg h-64 my-2 shadow p-10 md:p-3">
            ...
            <div className="flex justify-between mb-5">
                ...
                <div>
                  <h5 className="inline-flex items-center text-gray-500 leading-none font-normal mb-2">
                    ...
                    <svg
                      ...
                      className="w-3 h-3 text-gray-400 hover:text-gray-900 cursor-pointer ms-1"
                      aria-hidden="true"
                      xmlns="http://www.w3.org/2000/svg"
                      fill="currentColor"
                      viewBox="0 0 20 20"
              ...
              <div>
                <button
                  ...
                  data-dropdown-placement="bottom"
                  type="button"
                  className="px-3 py-2 inline-flex items-center text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-black-700 focus:z-10 focus:ring-4 focus:ring-gray-200"
                >
                  Last week{" "}
                  <svg
            ...
            <div className="grid grid-cols-1 items-center border-gray-200 border-t justify-between mt-2.5">
              <div className="pt-5">
                <a
                  href="#"
                  className="px-5 py-2.5 text-sm font-medium text-white inline-flex items-center bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:outline-none rounded-lg text-center"
                >
                  <svg
          ...
          <div className="max-w-sm w-full bg-white rounded-lg my-2 h-64 shadow md:p-1">
            ...
            <div className="grid grid-cols-2 py-3">
              <dl>
                ...
                <dd className="leading-none text-xl font-bold text-green-800">
                  $23,635
                </dd>
              </dl>
              <dl>
                ...
                <dd className="leading-none text-xl font-bold text-red-800">
                  -$18,230
                </dd>
              </dl>
            </div>
